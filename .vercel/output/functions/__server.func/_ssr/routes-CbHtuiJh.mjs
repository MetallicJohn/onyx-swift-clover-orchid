...
import { C as Activity, S as ArrowRight, i as Wallet, p as Radio, u as Shield } from "../_libs/lucide-react.mjs";
import { n as useCurrentUserState } from "./use-current-user-cIszCLdV.mjs";
import { n as SignedIn, r as SignedOut } from "./gates-CIzTqTsG.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CbHtuiJh.js
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SignedIn, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/app",
							className: "inline-flex h-12 items-center gap-2 rounded-md bg-accent px-5 font-medium text-accent-fg",

...
//#region node_modules/.nitro/vite/services/ssr/assets/rls-stkZtAMF.js
function cn(...inputs) {
...
async function emit(sql, event) {
	const { wireModules } = await import("./subscribers-BRhTNJh1.mjs");
	wireModules();
...
async function restoreCustomerAccess(sql, tenantId, customerId) {
	...
	const svcs = await sql`select id from services where tenant_id = ${tenantId} and customer_id = ${customerId}`;
...
//#endregion
export { slugify as A, provisionServiceAccess as C, saveMessagingSettings as D, restoreCustomerAccess as E, wrapPullRosScript as F, toPublic as M, webfamBalance as N, seal as O, wgAddressForIndex as P, open as S, renderFreeRadiusUsers as T, hint$1 as _, cn as a, nid as b, deliverSms as c, emit as d, enqueueAgentCommand as f, getMessagingSettings as g, ensureOpsSchema as h, channelAllowed as i, syncRadiusAccount as j, seedOpsForTenant as k, deliverWhatsapp as l, enrollFields as m, agentScript as n, commandRosScript as o, enqueueServiceCommand as p, applyRls as r, deliverChannel as s, agentPullUrl as t, disconnectRadiusUser as u, initialCommandStatus as v, publicRadiusAccount as w, on as x, kes as y };

...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DlmhJOOS.mjs");
...
var manifest = {
	"107df89607f4cf5642dd84e0b797075cd2a0d6ae8daf02cb91ea183e8afc75a8": {
		...
		importer: () => import("./server-DfJqWESy.mjs")
	},
	...
	"2c4985e96c199268f7f639534cb5e8e31d6b19d43286bf77416413db60ffde26": {
		...
		importer: () => import("../__root-B17Yck9H.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DH5OVAuE.mjs").then((n) => n.t),

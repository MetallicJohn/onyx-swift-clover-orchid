...
//#region node_modules/.nitro/vite/services/ssr/assets/server-more-DGqdDn90.js
...
createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((d) => d).handler(createSsrRpc("22bcb5c3d5edf5875466ea542ef918f35683ee50e646baceb4461db13efc758c"));
//#endregion
export { getPlan as a, linkReseller as c, queueCpeTask as d, redeemPoints as f, getAuditLog as i, listCpeTasks as l, assignOpenTicket as n, getReports as o, setPlan as p, commentOpenTicket as r, getStatement as s, askRouterOs as t, listTicketStaff as u };

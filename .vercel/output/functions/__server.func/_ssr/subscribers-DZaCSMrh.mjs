import { d as on, g as syncRadiusAccount, s as enqueueServiceCommand } from "./access-1saCIo2_.mjs";
import { s as restorePaidAccess } from "./access-policy-BX1fKswR.mjs";
import { i as writeInbox } from "./inbox-BYYGIUPO.mjs";
import { r as notifyCustomerEvent } from "./notifications-CBBMOK-P.mjs";
import { n as awardLoyalty, r as creditReseller } from "./resellers-DZusTvRo.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/subscribers-DZaCSMrh.js
...
function wireModules() {
	...
	on("payment.confirmed", async (sql, event) => {
		...
		if (p.invoice_paid !== false) await restorePaidAccess(sql, tenantId, customerId);

...
//#region node_modules/.nitro/vite/services/ssr/assets/server-C1t-C6za.js
var bootstrapWorkspace = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((d) => d).handler(createSsrRpc("b82b9e563917b8ca5c159855fbc036e93fae3ccf99f0f58fdfb124f9e0633d05"));
...
var getInvoice = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((d) => d).handler(createSsrRpc("d29992f7e813ce2a2df10e18aa1531c7a7662ea27648ba573b424d6e6a12e10a"));
var saveBillingSettings = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((d) => d).handler(createSsrRpc("d10de407eff592c85952061661ba87d1fba7422d507030cb442c829f990cc222"));
...
//#endregion
export { updatePackage as A, rotateServiceSecret as C, setTicketStatus as D, setServiceStatus as E, switchTenant as O, renameTenant as S, saveBillingSettings as T, listPackages as _, createPackage as a, listTickets as b, disconnectService as c, getInvoice as d, importCustomers as f, listNotifications as g, listMyTenants as h, createInvoice as i, updateNotificationTemplate as k, exportCustomersCsv as l, listCustomers as m, bootstrapWorkspace as n, createService as o, listBilling as p, createCustomer as r, createTicket as s, addRouter as t, getDashboard as u, listRouters as v, runAutomatedBilling as w, recordPayment as x, listServices as y };

...
import { i as hasGateSessionMarker } from "./server-BZunXvKg.mjs";
import { C as Activity, _ as Handshake, a as Users, b as Boxes, c as Ticket, d as Settings, f as Router, g as LayoutDashboard, h as Menu, l as Sparkles, n as Wrench, o as Upload, p as Radio, r as Wifi, t as X, u as Shield, v as CreditCard, x as Bell, y as ChartColumn } from "../_libs/lucide-react.mjs";
import { h as platformStatus } from "./server-more-C5Y0MTly.mjs";
import { O as switchTenant, h as listMyTenants, u as getDashboard } from "./server-C1t-C6za.mjs";
import { n as useCurrentUserState } from "./use-current-user-cIszCLdV.mjs";
import { i as UserButton, t as RedirectToSignIn } from "./gates-CIzTqTsG.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/app-D9zOKQR1.js
...
function AppShell({ tenantName, role, tenants, activeTenantId, onSwitchTenant, platformAdmin }) {
	const pathname = useRouterState({ select: (s) => s.location.pathname });
	const [open, setOpen] = (0, import_react.useState)(false);
	const nav = platformAdmin ? [...NAV, {
		to: "/app/admin",
		label: "Superadmin",
		icon: Shield
	}] : NAV;
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [gateSession ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/login",
...
function AppLayout() {
	...
	const [platformAdmin, setPlatformAdmin] = (0, import_react.useState)(false);

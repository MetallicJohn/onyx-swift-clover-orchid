...
| Billing / invoices / ledger | Implemented and tested |
| Payments Daraja/Kopo | Implemented and tested (live needs real till + callback URL) |
| RADIUS desired state | Implemented and tested — daemon architecture only |
...
| Scale (RLS, Redis, workers) | Architecture only |
